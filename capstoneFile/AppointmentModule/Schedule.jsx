...
const CreateAppointmentModal = ({ visible, onClose, onSubmit }) => {
    ...
    // Character count states for fields with limits
    ...
    // Input change handlers with character limits
    const handlePatientNameChange = (text) => {
        if (text.length <= CHAR_LIMITS.PATIENT_NAME) {
            setPatientName(text);
            setPatientNameCount(text.length);
        }
    };

    const handleEmailChange = (text) => {
        if (text.length <= CHAR_LIMITS.EMAIL) {
            setPatientEmail(text);
            setEmailCount(text.length);
        }
    };
    ...
    const handlePetNameChange = (text) => {
        if (text.length <= CHAR_LIMITS.PET_NAME) {
            setPetName(text);
            setPetNameCount(text.length);
        }
    };

    const handlePetTypeChange = (text) => {
        if (text.length <= CHAR_LIMITS.PET_TYPE) {
            setPetType(text);
            setPetTypeCount(text.length);
        }
    };

    const handleReasonChange = (text) => {
        if (text.length <= CHAR_LIMITS.REASON) {
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ maxHeight: 500 }}>
                            ...
                            <View style={[apStyle.formRow, {gap: 20}]}>
                                <View style={apStyle.formGroup}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 11, color: patientNameCount >= CHAR_LIMITS.PATIENT_NAME ? '#d32f2f' : '#999' }}>
                                            {patientNameCount}/{CHAR_LIMITS.PATIENT_NAME}
                                        </Text>
                                    </View>
                                    <TextInput
                                        ...
                                        maxLength={CHAR_LIMITS.PATIENT_NAME}
                                    />
                                </View>
                                ...
                                <View style={apStyle.formGroup}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 11, color: emailCount >= CHAR_LIMITS.EMAIL ? '#d32f2f' : '#999' }}>
                                            {emailCount}/{CHAR_LIMITS.EMAIL}
                                        </Text>
                                    </View>
                                    <TextInput
                                        style={apStyle.formInput}
                            ...
                            <View style={apStyle.formRow}>
                                <View style={apStyle.formGroup}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 11, color: phoneCount >= CHAR_LIMITS.PHONE ? '#d32f2f' : '#999' }}>
                                            {phoneCount}/{CHAR_LIMITS.PHONE}
                                        </Text>
                                    </View>
                                    <TextInput
                                        style={apStyle.formInput}
                        ...
                        <View style={[apStyle.formGroup, {marginBottom: 40}]}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <Text style={{ fontSize: 11, color: reasonCount >= CHAR_LIMITS.REASON ? '#d32f2f' : '#999' }}>
                                    {reasonCount}/{CHAR_LIMITS.REASON}
                                </Text>
                            </View>
                            <TextInput
                            ...
                            <View style={[apStyle.formRow, {gap: 20}]}>
                                <View style={apStyle.formGroup}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 11, color: petNameCount >= CHAR_LIMITS.PET_NAME ? '#d32f2f' : '#999' }}>
                                            {petNameCount}/{CHAR_LIMITS.PET_NAME}
                                        </Text>
                                    </View>
                                    <TextInput
                                        style={apStyle.formInput}
                                        ...
                                        placeholderTextColor="#999"
                                        maxLength={CHAR_LIMITS.PET_NAME}
                                    />
                                </View>
                                ...
                                <View style={apStyle.formGroup}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 11, color: petTypeCount >= CHAR_LIMITS.PET_TYPE ? '#d32f2f' : '#999' }}>
                                            {petTypeCount}/{CHAR_LIMITS.PET_TYPE}
                                        </Text>
                                    </View>
                                    <TextInput
                                        style={apStyle.formInput}
                                        ...
                                        placeholderTextColor="#999"
                                        maxLength={CHAR_LIMITS.PET_TYPE}
                                    />
                                </View>
                            </View>
                            ...
                            <View style={apStyle.formGroup}>
                                ...
                                <View style={apStyle.pickerContainer}>
                                    ...
                                    >
                                        ...
                                        <Picker.Item label="Wellness & Vaccination" value="Vaccination" />
                                        <Picker.Item label="Check-up or Consultation" value="Check-up" />
                                        <Picker.Item label="Deworming" value="Deworming" />
                                        <Picker.Item label="Parasite Control" value="Parasite Control" />
